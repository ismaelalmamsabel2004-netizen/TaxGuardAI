...
// Diseño Premium devuelto a su estado original
            ...
            <div className="p-4 md:p-8 space-y-8">
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex flex-col md:grid md:grid-cols-12 gap-2 md:gap-4 items-start md:items-center bg-slate-50/50 p-4 rounded-xl border border-slate-100">
                    ...
                    <div className="md:col-span-3 text-left md:text-right text-xs text-slate-500 font-medium">Cuota [03]: <span className="font-bold text-emerald-600">+{cuota21.toLocaleString('es-ES', {minimumFractionDigits:2})} €</span></div>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-amber-50 rounded-xl border border-amber-100 mt-2">
                    <span className="text-xs font-black text-amber-800 uppercase">Suma de cuotas [27]:</span>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex flex-col md:grid md:grid-cols-12 gap-2 md:gap-4 items-start md:items-center bg-slate-50/50 p-4 rounded-xl border border-slate-100">
                    ...
                    <div className="md:col-span-3 text-left md:text-right text-xs text-slate-500 font-medium">Cuota Deducible [29]: <span className="font-bold text-rose-600">-{cuotaGastos.toLocaleString('es-ES', {minimumFractionDigits:2})} €</span></div>
                  </div>
                </div>
              </div>
